...
const croppedImg = (src, alt) => (
  <div className="w-full max-w-md aspect-[4/5] overflow-hidden flex items-center justify-center">
...
const COLLECTIONS = [
  {
    ...
    type: "Emotional",
    tracks: [
      { id: "1", title: "Malinconia", desc: "", duration: "03.08", audio: "/audio/malinconia.wav", image: croppedImg("/images/malinconia.png", "Malinconia") },
...

  {
    ...
    tracks: [
      ...
      { id: "12", title: "Shock Protocol", desc: "", duration: "02.02", audio: "/audio/shock-protocol.wav", image: smallImg("/images/shock-protocol-2.png", "Shock Protocol") },
      { id: "13", title: "Every Shadow Hides", desc: "", duration: "02.06", audio: "/audio/every-shadow-hides.wav", image: smallImg("/images/every-shadow-hides.png", "Every Shadow Hides") },
...

  {
    ...
    tracks: [
      ...
      { id: "17", title: "Life Is a Daisy Wish", desc: "", duration: "01.58", audio: "/audio/life-is-a-daisy-wish.wav", image: smallImg("/images/life-is-a-daisy-wish.png", "Life Is a Daisy Wish") },
      { id: "18", title: "A Little Braver Now", desc: "", duration: "02.15", audio: "/audio/a-little-braver-now.wav", image: smallImg("/images/a-little-braver-now.png", "A Little Braver Now") },
...
function getImageSrc(track) {
  return track?.image?.props?.src || track?.image?.props?.children?.props?.src || null;
}
