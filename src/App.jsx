...
const COLLECTIONS = [
  {
    ...
    tracks: [
      ...
      { id: "3", title: "The Liminal Passage", status: "", desc: 'inspired by "A Constellation of Vital Phenomena" by Anthony Marra', duration: "04.39", audio: "/audio/the-liminal-passage.wav", image: img("/images/the-liminal-passage.png", "The Liminal Passage") },
      { id: "4", title: "Ridge of Desolation", status: "", desc: "", duration: "02.42", audio: "/audio/ridge-of-desolation.wav", image: img("/images/ridge-of-desolation.png", "Ridge of Desolation") },
      { id: "5", title: "The Quiet Between", status: "", desc: "", duration: "03.28", audio: "/audio/the-quiet-between.wav", image: smallImg("/images/the-quiet-between.png", "The Quiet Between") },
      { id: "6", title: "Iben's Dance", status: "", desc: "", duration: "02.31", audio: "/audio/ibens-dance.wav", image: img("/images/ibens-dance.png", "Iben's Dance") },
      { id: "7", title: "Under Currents", status: "", desc: 'a character study on Arab from "Moby Dick" by Herman Melville', duration: "02.46", audio: "/audio/under-currents.wav", image: smallImg("/images/arab.png", "Under Currents") },
      { id: "8", title: "Nival", status: "", desc: "", duration: "02.36", audio: "/audio/nival.wav", image: img("/images/nival.png", "Nival") },
      { id: "9", title: "The Wave Is Already Water", status: "UPCOMING", desc: "", duration: "03.22", audio: "/audio/the-wave-is-already-water.wav", image: img("/images/the-wave-is-already-water.png", "The Wave Is Already Water") },
      { id: "10", title: "Suite", status: "", desc: "", duration: "03.36", audio: "/audio/suite.mp3", image: img("/images/suite.png", "Suite") },
      { id: "11", title: "Watch the Voltage", status: "UPCOMING", desc: 'inspired by "Revival" by Stephen King', duration: "03.05", audio: "/audio/watch-the-voltage.wav", image: img("/images/watch-the-voltage.png", "Watch the Voltage") },
    ],
  },
  {
    title: "Orchestral",
    ...
    tracks: [
      ...
      { id: "14", title: "Malinconia", status: "UPCOMING", desc: "", duration: "03.08", audio: "/audio/malinconia.wav", image: smallImg("/images/malinconia.png", "Malinconia") },
      ...
      { id: "18", title: "Life Is a Daisy Wish", status: "UPCOMING", desc: "", duration: "01.58", audio: "/audio/life-is-a-daisy-wish.wav", image: smallImg("/images/life-is-a-daisy-wish.png", "Life Is a Daisy Wish") },
      { id: "19", title: "Through Smoke and Starlight", status: "UPCOMING", desc: 'inspired by "The Night Circus" by Erin Morgenstein', duration: "02.24", audio: "/audio/through-smoke-and-starlight.wav", image: img("/images/through-smoke-and-starlight.png", "Through Smoke and Starlight") },
    ],
  },
  {
    title: "Trailer Music",
    type: "Showcase",
    tracks: [
      { id: "20", title: "Asura Rising", status: "UPCOMING", desc: "", duration: "02.36", audio: "/audio/asura-rising.wav", image: img("/images/asura-rising 8.png", "Asura Rising") },
      { id: "21", title: "Shock Protocol", status: "UPCOMING", desc: "", duration: "02.02", audio: "/audio/shock-protocol.wav", image: smallImg("/images/shock-protocol-2.png", "Shock Protocol") },
      { id: "22", title: "Every Shadow Hides", status: "UPCOMING", desc: "", duration: "02.06", audio: "/audio/every-shadow-hides.wav", image: smallImg("/images/every-shadow-hides.png", "Every Shadow Hides") },
      { id: "23", title: "Velocidad", status: "UPCOMING", desc: "", duration: "02.07", audio: "/audio/velocidad.wav", image: img("/images/velocidad.png", "Velocidad") },
    ],
  },
];
